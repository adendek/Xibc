...
if doTest:
    ...
    IOHelper().inputFiles([
#         '/afs/cern.ch/work/z/zhli/00054429_00000001_3.AllStreams.mdst'  
        '/afs/cern.ch/work/z/zhli/00053485_00000900_1.bhadron.mdst'
                ], clear=True)
...
importOptions("My2016Lb0TupleTree.py")
