...
void addVar(int iDecay){
  ...
  outfile = topdir+"JpsiXicz/All_"+run+"_"+mag+".pkkpi."+sign+".root";   

  
  TFile *f = new TFile(infile);
  
  TTree *oldtree = (TTree*)f->Get(treeName);
  double K1_MC12TuneV3_ProbNNk;
  double K2_MC12TuneV3_ProbNNk;
  double Pr_MC12TuneV3_ProbNNp;  
  double Pi_MC12TuneV3_ProbNNpi;  

  double Pr_ProbNNp, K1_ProbNNk, K2_ProbNNk, Pi_ProbNNpi;
  double Pr_V3ProbNNp, K1_V3ProbNNk, K2_V3ProbNNk, Pi_V3ProbNNpi;

  oldtree->SetBranchAddress("K1_MC12TuneV3_ProbNNk", &K1_MC12TuneV3_ProbNNk);  
  oldtree->SetBranchAddress("K2_MC12TuneV3_ProbNNk", &K2_MC12TuneV3_ProbNNk);  
  ...
  newtree->Branch("K1_V3ProbNNk", &K1_V3ProbNNk);
  newtree->Branch("K2_V3ProbNNk", &K2_V3ProbNNk);
  ...
  cout << "Looping over " << nentries << " entries" << endl;
   ...
   for (Long64_t i=0;i<nentries; i++) {
      ...
      K1_V3ProbNNk = K1_MC12TuneV3_ProbNNk;
      K2_V3ProbNNk = K2_MC12TuneV3_ProbNNk;
