...
void doComb(TString mode, TTree *tree1, TCut allCut, TString projMass = "Xb_M", TString name = "XXX"){
  ...
  //allCut2 = allCut2 && "abs(Xc_M-2470)>20";
  ...
  if(mode=="JpsiLc" || mode=="JpsiXic"){
    ...
    const int nPart = 3;
    // This corresponds to your 4 particles, e.g.   Jpsi, proton, kaon, pion
    TString pfx[nPart]={"p","k","pi"}; // prefix for your particles
    int swapPion[nPart] = {0, 0, 0};  // These are switches to assign particle the pion mass
    int swapKaon[nPart] = {0, 0, 0};  // These are switches to assign particle the kaon mass
    int swapProton[nPart] = {0, 0, 0};//, 0, 0}; // These are switches to assign particle the proton mass
  }else if(mode=="XiccMu"){
    const int nPart = 4;
    // This corresponds to your 4 particles, e.g.   Jpsi, proton, kaon, pion
    TString pfx[nPart]={"p","k","pi", "PI"}; // prefix for your particles
    int swapPion[nPart] = {0, 0, 0, 0};  // These are switches to assign particle the pion mass
    int swapKaon[nPart] = {0, 0, 0, 0};  // These are switches to assign particle the kaon mass
    int swapProton[nPart] = {0, 0, 0, 0};//, 0, 0}; // These are switches to assign particle the proton mass
  }else if(mode=="OmczMu" || mode=="XiczMu"){
    const int nPart = 4;
    // This corresponds to your 4 particles, e.g.   Jpsi, proton, kaon, pion
    TString pfx[nPart]={"p","K1","K2", "pi"}; // prefix for your particles
    int swapPion[nPart] = {1, 0, 0, 0};  // These are switches to assign particle the pion mass
    int swapKaon[nPart] = {0, 0, 0,0 };  // These are switches to assign particle the kaon mass
    int swapProton[nPart] = {0, 0, 0, 0};//, 0, 0}; // These are switches to assign particle the proton mass
  }
