...
# =====================================================================================
#
# This is for V2 tune of ProbNNs. To execute, modify to point to relevant MC files:
#
# ./batch_Lb2JpsiK.v2.sh
#
# =====================================================================================

EOSDIR=root://eoslhcb.cern.ch//eos/lhcb/user/p/poluekt/PID/
#
...
CALIBFILE1=$EOSDIR/ProbNNp/P_MagUp_2012_distrib.root
CALIBFILE2=$EOSDIR/ProbNNK/K_MagUp_2012_distrib.root
# Run the script
python PIDGen.py -i $INPUTFILE1 -t $INPUTTREE -o $OUTFILE1 -p $PIDVAR1 -m $PTVAR1 -e $ETAVAR1 -n $NTRVAR -l $LOWPID1 -c $CALIBFILE1
python PIDGen.py -i $INPUTFILE2 -t $INPUTTREE -o $OUTFILE2 -p $PIDVAR2 -m $PTVAR2 -e $ETAVAR2 -n $NTRVAR -l $LOWPID2 -c $CALIBFILE2
