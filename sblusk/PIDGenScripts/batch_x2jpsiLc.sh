...
INPUTFILE1=$INPUTDIR/JpsiLc_mc.root
INPUTFILE2=$INPUTDIR/JpsiLc_mc.p.root
INPUTFILE3=$INPUTDIR/JpsiLc_mc.pk.root
...
OUTFILE1=$INPUTDIR/JpsiLc_mc.p.root
OUTFILE2=$INPUTDIR/JpsiLc_mc.pk.root
OUTFILE3=$INPUTDIR/JpsiLc_mc.pkpi.root
#OUTFILE=out.root
