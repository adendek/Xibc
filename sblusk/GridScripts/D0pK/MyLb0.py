...
selCode = "M > 5000*MeV"
_Lb02D0L0Filt = FilterDesktop('_Lb02D0L0Filt', Code=selCode )
...
#----------------------------------------------------
selCode = "M > 5000*MeV"
_MyLb0Filt = FilterDesktop('_MyLb0Filt', Code=selCode )
...
fltrs = LoKi_Filters (STRIP_Code = " HLT_PASS_RE('StrippingLb2D0PHD02HHBeauty2CharmDecision') ")
