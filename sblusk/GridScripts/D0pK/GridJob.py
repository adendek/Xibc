...
filesPerJob = 1   #def = 20
maxFiles = 1
CPUTime     = 60*60*15
jobName     = "D11"
outputfile  = "tuple.root"
summaryfile = "summary.xml"
inputdir = '/afs/cern.ch/user/s/sblusk/Xibc/D0pK/'
backend=Dirac()
...
def getMCDataSet(pol):
    ...
    if DecID == "16265034":
        ...
        vStrip = "21"
        vReco = "Reco14c"
    elif DecID == "16163060" or DecID == "16164060":
        sim = "Sim09a"
        vStrip = "21"
        vReco = "Reco14c"
    ...
    if DecID == "16163060" or DecID == "16164060":
