...
inputdir = '/afs/cern.ch/user/s/sblusk/Xibc/LcD0/'
backend=Dirac()
...
def getMCDataSet(pol):
    ...
    #DecID = "12163001"   # B- -> D0 pi-   sim08h, Digi13, Reco14c
    #DecID = "16164060"   # Xibc -> D0 p K  sim09a, Digi13, Reco14c
    #DecID = "15164021"   # Lb-->D0 p sim08h, Digi13, Reco14c
    DecID = "16295060"   # Lb--> Lambda_c+ D0 sim09a, Digi13, Reco14c
    ...
    if DecID == "16265034":
        ...
        vStrip = "21"
        vReco = "Reco14c"
    elif DecID == "16163060" or DecID == "16164060" or DecID == "16295060":
        sim = "Sim09a"
        vStrip = "21"
        vReco = "Reco14c"
    ...
    if DecID == "16163060" or DecID == "16164060" or DecID == "16295060":
