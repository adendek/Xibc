...
inputdir = '/afs/cern.ch/user/s/sblusk/Xibc/Xb2LbPi/'
backend=Dirac()
...
def getMCDataSet(pol):
    ...
    #DecID = "16265062"   # Xibc - -> Xib0 Pi  sim09a, reco14c, (Digi13)
    DecID = "16265061"   # Xibc - -> Lb Pi  sim09a, reco14c, (Digi13)
    ...
    if DecID == "16265034":
        ...
        vStrip = "20"
        vReco = "Reco14a"
    elif DecID == "16265061" or DecID == "16265062":
        sim = "Sim09a"
        vStrip = "21"
        vReco = "Reco14c"
    ...
    if DecID == "16265061" or DecID == "16265062":
